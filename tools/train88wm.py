...
def main():
    ...
    listPadding=[0.001,0.005,0.01] #[0.0003,0.00025,0.00023,0.0002,0.00018,0.00015,0.00013,0.0001] #[0.0003,0.0002]#
    resPadding=[]
    cudnn.benchmark = False
    ...
    argsXtt=["SOLVER.BASE_LR",0.0002]
    cfg.merge_from_list(argsXtt)
    f=open(os.path.join(cfg.OUTPUT_DIR,"choosePW.txt"),"w")
    listWarm=[0.0001,0.0003,0.0004,0.0005,0.0006,0.0007] #[0.0001,0.0003,0.0004,0.0005,0.0006,0.0007,0.001]#[0.0005,0.0001]
    resWarm=[]
