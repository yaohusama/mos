...
def main():
    ...
    listWarm=[0.01,0.05,0.1] #[0.0001,0.0003,0.0004,0.0005,0.0006,0.0007,0.001]#[0.0005,0.0001]
    resWarm=[]
    for item in listWarm:
        ...
        resWarm.append(tmp)
        cudnn.benchmark = False
    f.write("best lr: "+str(0.0002)+";best weight decay: "+str(listWarm[np.argmax(resWarm)])+";map: "+str(max(resWarm)))
    f.close()
