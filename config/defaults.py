...
# Name of backbone
_C.MODEL.NAME = 'resnet50' #'swinTransformer'#resnet50
# Last stride of backbone
_C.MODEL.LAST_STRIDE = 1
# Path to pretrained model of backbone
_C.MODEL.PRETRAIN_PATH = '/home/xtt/.cache/torch/hub/checkpoints/'
# Use ImageNet pretrained model to initialize backbone or use self trained model to initialize the whole model
# Options: 'imagenet' or 'self'
_C.MODEL.PRETRAIN_CHOICE = 'imagenet'
# If train with BNNeck, options: 'bnneck' or 'no'
_C.MODEL.NECK = 'no' #'bnneck'
...
# If trainer with arcface loss, options: 'True', 'False'
...
_C.MODEL.METRIC_LOSS_TYPE = 'triplet'
# If trainer with multi-gpu ddp mode, options: 'True', 'False'
_C.MODEL.DIST_TRAIN = False
# If trainer with soft triplet loss, options: 'True', 'False'
_C.MODEL.NO_MARGIN = False

_C.MODEL.ID_LOSS_TYPE = 'softmax'
_C.MODEL.ID_LOSS_WEIGHT = 1.0
_C.MODEL.TRIPLET_LOSS_WEIGHT = 1.0
_C.MODEL.PART_LOSS_WEIGHT = 1.0
...
_C.DATALOADER.NUM_INSTANCE = 16#16
